...
// function hasSpecChar(str: string) {
//   let specChar = false;
//   for (const ch of str) if (DELIMITERS_REGEX.test(ch)) specChar = true;
//   return specChar;
// }
// /** Function to determine is string should be escaped */
// function shouldBeEscaped(
//   str: string,
//   isLastPartialQouted: boolean,
//   escapeAll: boolean
// ) {
//   if (escapeAll) return true;
//   if (isLastPartialQouted) return true;
//   if (hasSpecChar(str)) return true;
//   return false;
// }
// type AddStringSuggOpts = {
//   commitCharacters?: string | string[];
//   escapeChar?: "'" | '"' | "[";
//   escapeAll?: boolean;
//   addedCharacters?: string;
// };
// const defAddStringSuggOpts: AddStringSuggOpts = {
//   escapeAll: false,
//   escapeChar: '"',
//   commitCharacters: undefined,
//   addedCharacters: undefined,
// };
// export function addStringSugg(
//   suggestions: string[],
//   replaceRange: vscode.Range,
//   lastPartial: string,
//   opts?: AddStringSuggOpts
...
//   let isLastPartialQouted: boolean = false;
...
//       const isEscaped = shouldBeEscaped(
//         el,
//         isLastPartialQouted,
//         !!hOpts.escapeAll
//       );
